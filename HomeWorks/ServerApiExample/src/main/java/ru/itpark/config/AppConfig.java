...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:postgresql://localhost:5432/kashapov_bd");
    ...
    public SessionFactory sessionFactory() {
        ...
        // builder.addResource("ru\\itpark\\clients.sql");
        // builder.addResource("ru\\itpark\\credits.sql");
        builder.addAnnotatedClasses(Credits.class);
